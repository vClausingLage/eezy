import { StyleSheet, Text, SafeAreaView, Platform, StatusBar, TextInput, Button } from 'react-native';
import { useState } from 'react'

/* import { checkMetarIntegr } from './helpers/metar-regex'; */
import { prepareMetar, reduceTempo, maptoMetarObj } from './helpers/metar-regex'; 
...
export default function App() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <StatusBar />
      <Text>Quick and EEzy METAR</Text>
      <TextInput
        style={styles.input}
