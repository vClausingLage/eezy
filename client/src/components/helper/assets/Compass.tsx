...
function Compass(props: Props) {
  ...
  return (
    <>
     {typeof(props.degrees) !== 'number' && <p>die degrees sind keine nummer</p>}
      {typeof(props.degrees) !== 'string' && <p>die degrees sind kein string</p>}
      ...
      <g style={{transformBox: 'fill-box', transformOrigin: 'center', transform: `rotate(${props.degrees}deg)`}} >
