...
module.exports = {
  ...
  googleClientSecret: "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",
};

// import { mongoURIDev } from "./dev.js";
// import { mongoURIProd } from "./prod.js";
// import { airportUriDev } from "./dev.js";
// import { airportUriProd } from "./prod.js";
...
// export let airportDB: string | undefined;

// if (process.env.NODE_ENV === "production") {
//   airportDB = airportUriProd;
// } else {
//   airportDB = airportUriDev;
// }
